...
public abstract class GameLevel implements ActionListener 
{
        ...
        ArrayList<Card> GameOver1 = new ArrayList<Card>();
        ...
        protected int toInt(Card card) {

                if ((!card.getRank().equals("t")) && (!card.getRank().equals("j")) && (!card.getRank().equals("q")) && (!card.getRank().equals("k")) && (!card.getRank().equals("a")))
                        return Integer.parseInt(card.getRank());

                else if (card.getRank().equals("t"))
                        return 10;
